...
Future<void> testExecutable(FutureOr<void> Function() testMain) async {
  return GoldenToolkit.runWithConfiguration(
    ...
    config: GoldenToolkitConfiguration(
      // Goldens are only asserted in CI where the pixel_5 AVD emulator
      // produces the committed baselines. On developer machines, run
      // with --update-goldens to regenerate or set the CI env var.
