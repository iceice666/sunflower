...
class Rustup {
  ...
  static List<_Toolchain> _getInstalledToolchains() {
    ...
    // Keep channel toolchains and explicit version toolchains such as 1.95.0.
    // Sunflower pins Rust through flake.nix/Cargo.toml, so Cargokit must not
    // silently fall back to whatever the user's "stable" happens to be.
