...
abstract final class PlayerCapabilities {
  ...
  static bool get backgroundAudio => Platform.isAndroid || Platform.isIOS;

  /// True if the platform provides OS media session controls (lock screen,
  /// notification shade, Bluetooth head-set buttons).
  static bool get mediaSession => Platform.isAndroid || Platform.isIOS;

  /// True if the platform supports downloading tracks to local storage for
  /// offline playback (M6).
  static bool get offlineDownloads => Platform.isAndroid || Platform.isIOS;
  ...
  static bool get rangeSeek => Platform.isAndroid || Platform.isIOS;
}
